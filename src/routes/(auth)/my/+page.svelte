		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 my-12 sm:my-16">
			...
			>
				<div class="flex items-center space-x-3">
					<svg
						...
						></svg
					>
					<h3 class="text-teal-600 group-hover:text-white text-md font-semibold">Chat AI</h3>
				</div>
				<p class="text-slate-500 group-hover:text-white text-sm">
					Checkout new features and start your session with AI.
				</p>
				<div class="inline-flex items-center hover:text-white text-cyan-600">
					<span class="text-sm md:text-base font-semibold">Start AI chat</span>
					<svg
			...
			>
				<div class="flex items-center space-x-3">
					...
					<h3 class="text-teal-600 group-hover:text-white text-md font-semibold">Settings</h3>
				</div>
				<p class="text-slate-500 group-hover:text-white text-sm">
					Edit your account settings, avatar, name, password etc.
				</p>
				<div class="inline-flex items-center hover:text-white text-cyan-600">
					<span class="text-sm md:text-base font-semibold">View My Profile</span>
					<svg
						class="fill-current w-4 h-4 ml-2"
						viewBox="0 0 18 12"
						xmlns="http://www.w3.org/2000/svg"
			...
			>
				...
				<p class="text-slate-500 group-hover:text-white text-sm">
					Need any help? Reach out to one of our developers!
				</p>
				<div class="inline-flex items-center hover:text-white text-cyan-600">
