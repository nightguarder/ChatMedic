...
<section class="min-h-screen snap-start snap-normal" id="one">
	<div class="max-w-7xl px-10 mx-auto sm:text-center">
		...
		<h2 class="font-bold text-2xl sm:text-2xl lg:text-4xl mt-3">
			Proceed by one of the following:
		</h2>
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 my-12 sm:my-16">
			<!-- Login -->
			<a
				href="./login"
				class="group block max-w-xs mx-auto rounded-lg p-6 ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-sky-500 hover:ring-sky-500"
			>
				<div class="flex items-center space-x-3">
					<svg
						...
						></svg
					>
					<h3 class="text-teal-600 group-hover:text-white text-md font-semibold">Login</h3>
				</div>
				<p class="text-slate-500 group-hover:text-white text-sm">
					Have an account? Proceed by logging in!
				</p>
			...
			>
				<div class="flex items-center space-x-3">
					...
					<h3 class="text-teal-600 group-hover:text-white text-md font-semibold">Register</h3>
				</div>
				<p class="text-slate-500 group-hover:text-white text-sm">
					Are you new here? Create an account for free!
				</p>
				<div class="inline-flex items-center hover:text-white text-cyan-600">
			...
			>
				<div class="flex items-center space-x-3">
					...
					<h3 class="text-teal-600 group-hover:text-white text-md font-semibold">About</h3>
				</div>
				<p class="text-slate-500 group-hover:text-white text-sm">
					Want to learn more? Read more about the project!
				</p>
				<div class="inline-flex items-center hover:text-white text-cyan-600">
			...
			>
				<div class="flex items-center space-x-3">
					...
					<h3 class="text-teal-600 group-hover:text-white text-md font-semibold">Contact</h3>
				</div>
				<p class="text-slate-500 group-hover:text-white text-sm">
					Got a question? Reach out to one of our developers!
				</p>
				<div class="inline-flex items-center hover:text-white text-cyan-600">
	...
	<div class="max-w-7xl px-10 mx-auto text-center items-center">
		<div class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">
			<p class="lead-relaxed py-5 max-w-lg sm:text-base md:text-lg text-center">
				The goal of the ChatMedic project is to provide medical professionals with a reliable,
				accurate, and easy-to-use AI assistant that can help them make informed decisions and
